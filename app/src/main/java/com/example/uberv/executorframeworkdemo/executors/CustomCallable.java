...
public class CustomCallable implements Callable {
    ...
    private WeakReference<MyThreadPoolManager> mCustomThreadPoolManagerWeakReference;
    ...
    public void setCustomThreadPoolManager(MyThreadPoolManager customThreadPoolManager) {
